...
def PRoMPs_extraction(N_BASIS, N_DOF, N_T, json_files_path, save_file_path):
        ...
        for index, js in enumerate(json_files):
            with open(os.path.join(json_files_path, js)) as json_file:
                ...
                joint_matrix = np.vstack(np.array(joint_pos)[:, 0])
        ...
        plot_traj_distribution_1_joint(save_path=save_file_path, config=config, mean_traj_1=MEAN_TRAJ_PROMP, traj_std_1= STD_TRAJ_PROMP,mean_traj_2=MEAN_TRAJ, traj_std_2= STD_TRAJ,show = False, save = True)
...
if __name__ == '__main__':
    ...
    for i in range(60):
        ...
        MEAN_TRAJ,COV_TRAJ,MEAN_WEIGHTS,COV_WEIGHTS=PRoMPs_extraction(N_BASIS, N_DOF, N_T,json_files_path=json_file_path, save_file_path=save_file_path)
