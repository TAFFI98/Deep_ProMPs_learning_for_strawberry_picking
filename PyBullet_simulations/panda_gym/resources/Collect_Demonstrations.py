...
def Single_Cofiguration_Rec(config):
    ...
    ClusterId = Cluster_l.Cluster(Cluster_position, client_id=physics_client_id)
    ...
    for demo in range(10):
            ...
            ClusterId.disable_collisions(physics_client_id, pandaId.panda)
...
if __name__ == '__main__':
    ''' 10 samples for 20 different configurations are recorded '''
    print('Start of the Demonstrations Collection')
    for config in range(18,20):
